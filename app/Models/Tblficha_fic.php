...
class Tblficha_fic extends Model
{
    ...
    protected $fillable = [
        'fic_fecha','per_id','fic_marca','fic_placa','fic_modelo','fic_km','fic_anio','fic_tarjetapropiedad','fic_soat','fic_fechavencimiento','fic_lunasoscuras','fic_trabajosarealizar','fic_inventariovehiculo','fic_observaciones','fic_nivelcombustible','fic_adjunto','fic_ordentrabajo','fic_firma','fic_svg','user_id'
    ];
