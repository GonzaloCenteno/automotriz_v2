...
class FichaController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $svg = str_replace('width="297mm" height="210mm"', 'width="100%" height="100%"', $ficha->fic_svg);
        ...
        return view('ficha.edit', compact('ficha','inventario','svg'));
    }
    ...
    public function imprimir_reporte_ficha(Request $request, $id)
    {
        ...
        if ($sql->count() > 0) 
        {
            $view = \View::make('reportes.vw_ficha',compact('sql','empresa','inventario','materiales','html'))->render();
